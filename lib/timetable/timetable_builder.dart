...
class AgendaBuilder extends StatefulWidget {
  ...
  @override
  _AgendaBuilderState createState() => _AgendaBuilderState();
}

class _AgendaBuilderState extends State<AgendaBuilder> {
  @override
  Widget build(BuildContext context) => Column(children: _buildAgenda());
  ...
  List<Widget> _buildAgenda() {
    ...
    while (i <= widget.day!['projects'].length) {
      toReturn.add(Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
        Container(
          height: 70,
          ...
          child: Stack(
            ...
            children: [
              Text(
                ...
                style: TextStyle(color: accentColor(0.7, widget.accent!, 0.2, 0.4)),
              ),
              Align(
                  ...
                  child: (i == widget.day!['projects'].length)
                      ? Text(
                          ...
                          style: TextStyle(color: accentColor(0.4, widget.accent!, 0.2, 0.4)),
                        )
                      : Container(
                          height: 30,
                          width: 3,
                ...
                : SlikkerCard(
                    ...
                    child: SizedBox(
                      ...
                      child: Row(children: [
                        ...
                        Container(width: 20),
                        Flexible(child: Text('Add a new thing'))
                      ]),
                    )))
      ]));
