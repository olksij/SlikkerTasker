...
class TimetableEditor extends StatelessWidget {
  ...
  const TimetableEditor({this.timetable = const {'days': []}, this.accent = 240});
  ...
  Widget build(BuildContext context) {
    return SlikkerScaffold(
                    ...
                    child: Padding(
                      ...
                      child: SlikkerCard(
                        ...
                        child: Container(
                            ...
                            height: 46,
                            child: Center(
                              child: Icon(Icons.save_rounded, color: Color(0xFF6666FF)),
                            )),
                      ),
                    ))
              ]))),
      content: ListView(
        ...
        shrinkWrap: true,
        children: [
          for (Map<String, dynamic> day in timetable['days'])
            SlikkerCard(
              accent: 240,
              isFloating: false,
              onTap: () {},
              ...
              child: Row(
                children: [
                  for (Map<String, dynamic> project in day['projects'])
                    Padding(
            ...
            child: Container(
              ...
              child: Center(
                child: Row(mainAxisSize: MainAxisSize.min, children: <Widget>[
                  ...
                  Text('Add new day',
                      style: TextStyle(
                          color: accentColor(0.75, accent, 0.15, 0.5), fontWeight: FontWeight.w600, fontSize: 16))
                ]),
              ),
            ),
          )
