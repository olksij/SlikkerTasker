...
class _AddItemState extends State<AddItem> {
    ...
    return DraggableScrollableSheet(
      builder: (context, scrollController) => PageView(
        children: [
          ...
          if (newItem['project'] != null && data.get(newItem['project'])['categories'] != null)
            chooseCategoryPage(context, scrollController, pageController),
      ...
      Column(
        children: [
          Text('Choose what will you do',
              style: TextStyle(fontSize: 17, color: accentColor(1, widget.accent!, 0.3, 0.5))),
          Container(
            height: 5,
          ),
        ],
      ...
      if (key[0] == 'P' || key[0] == 'P')
        cards.add(InfoCard(
          ...
          onCardTap: () {
            ...
            pageController!.nextPage(duration: Duration(milliseconds: 300), curve: Curves.easeInOutQuart);
          },
        ));
    });
        ...
        child: Container(
          decoration: BoxDecoration(
              gradient: LinearGradient(
                  begin: Alignment.topCenter, end: Alignment(0, 0.25), colors: [Color(0xFFFAFAFF), Color(0x00FAFAFF)])),
          height: 50,
        ),
      ),
      Align(
        ...
        child: Container(
          decoration: BoxDecoration(
              gradient: LinearGradient(
                  begin: Alignment.topCenter, end: Alignment(0, 0.25), colors: [Color(0x00FAFAFF), Color(0xFFFAFAFF)])),
          height: 80,
        ),
      ),
    ]);
  ...
  Widget chooseCategoryPage(BuildContext context, ScrollController scrollController, PageController? pageController) {
    List<Widget> cards = [
      Column(
        children: [
          Text('Choose what exactly will you do',
              style: TextStyle(fontSize: 17, color: accentColor(1, widget.accent!, 0.3, 0.5))),
          Container(
            height: 5,
          ),
    ...
    data.get(newItem['project'])['categories'].forEach((value) {
      cards.add(SlikkerCard(
        ...
        child: Text(value,
            ...
            style: TextStyle(color: accentColor(1, widget.accent!, 0.4, 0.4), fontSize: 15)),
      ));
    });
    return Stack(children: [
      StaggeredGridView.countBuilder(
  ...
  Widget chooseDurationPage(BuildContext context, ScrollController scrollController, PageController? pageController) =>
      Stack(children: [
        Column(children: [
          Column(
            children: [
              ...
              Text('Choose duration', style: TextStyle(fontSize: 17, color: accentColor(1, widget.accent!, 0.3, 0.5))),
              Container(height: 10),
            ],
          ),
          Container(
